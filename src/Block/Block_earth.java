...
public class Block_earth extends Block{

    static String Texture_path = "Textures/Terrain/Terrain/Earth/Earth.png";

    static Material mat = null;
    static Texture tex = null;

    public Block_earth(Vector3f p, AssetManager assetManager)
    {
        block_type = "earth";
        block_id = idnum++;
        block_hardness = 3;
